...
path = r'E:\Download\Tasks\Python_Learning\python_pra3\\'  #html要保存的路径

# 一个html的头文件
input = open(r'E:\Download\Tasks\Python_Learning\python_pra3\test.html', 'r')
head = input.read()

# 打开python教程主界面
f = request.urlopen("http://www.liaoxuefeng.com/wiki/001374738125095c955c1e6d8bb493182103fac9270762a000")
home = f.read()
f.close()
